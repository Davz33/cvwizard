...
```{r}
if(params$pdf_mode){
  cat("View this CV online with links at _davidevitiello.com_")
} else {
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/Davz33/cvwizard/raw/main/cv.pdf)")
}
```
