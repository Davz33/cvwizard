...
create_CV_object <-  function(data_location,
  ...
  if(is_google_sheets_location){
    ...
    cv$skills        <- read_gsheet(sheet_id = "coding_skills")
    ...
    cv$skills       <- readr::read_csv(paste0(data_location, "conding_skills.csv"), skip = 1)
...
print_skill_bars <- function(cv, out_of = 5, bar_color = "#ff9900", bar_background = "#ff99007a", glue_template = "default"){
...
#' @description Construct a bar chart of languages
#' @param out_of The relative maximum for skills. Used to set what a fully filled in skill bar is.
print_languages_bars <- function(cv, out_of = 6, bar_color = "#185abd", bar_background = "#185abd96", glue_template = "default"){
